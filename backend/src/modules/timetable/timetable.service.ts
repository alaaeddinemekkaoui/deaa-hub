...
export class TimetableService {
  ...
  async findAll(query: SessionQueryDto) {
    ...
    const where: Prisma.TimetableSessionWhereInput = filters.length ? { AND: filters } : {};
  ...
  private detectConflicts(sessions: Awaited<ReturnType<typeof this.prisma.timetableSession.findMany>>) {
