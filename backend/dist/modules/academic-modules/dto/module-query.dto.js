...
class ModuleQueryDto extends pagination_dto_1.PaginationDto {
    search;
    filiereId;
    optionId;
    sortBy = 'name';
...
], ModuleQueryDto.prototype, "filiereId", void 0);
__decorate([
    (0, class_validator_1.IsOptional)(),
    (0, class_transformer_1.Type)(() => Number),
    (0, class_validator_1.IsInt)(),
    (0, class_validator_1.Min)(1),
    __metadata("design:type", Number)
], ModuleQueryDto.prototype, "optionId", void 0);
__decorate([
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsIn)(['name', 'semestre', 'createdAt', 'updatedAt']),
    __metadata("design:type", String)
